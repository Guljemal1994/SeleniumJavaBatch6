...
public class ExplicitWaitDemo {
	...
	public static void main(String[] args) {
		 ...
		 * an "ElementNotVisibleException". Explicit wait works with
		 * ExpectedConditionsClass and wait untill condition becomes true or max amount
		 * of time is reached.
		 */
		...
		boolean text = driver.findElement(By.xpath("//h4[contains(text(),'Welcome Syntax Technologies')]"))
				.isDisplayed();
